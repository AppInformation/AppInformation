...
<div class="m_left">
    ...
    <div class="left_m">
        ...
        <ul>
            ...
            <c:if test="${sessionScope.loginUser.type==1}">
            	<li><a href="${ctx}/userListServlet"  <c:if test="${menu==8}"> class="now" </c:if>>用户列表</a></li>
            </c:if>
        </ul>
    </div>
    <c:if test="${sessionScope.loginUser.type==1}">
    <div class="left_m">
        ...
        <ul>
            <li><a href="${ctx}/ProductCategoryServlet?action=SelectProductCategory" <c:if test="${menu==4}"> class="now" </c:if>>分类管理</a></li>
            <li><a href="${ctx}/ProductServlet"  <c:if test="${menu==5}"> class="now" </c:if>>商品管理</a></li>
    ...
    <div class="left_m">
        ...
        <ul>
            <li><a href="${ctx}/NewsServlet?action=SelectNews"  <c:if test="${menu==7}"> class="now" </c:if>>资讯列表</a></li>
        </ul>
    </div>
</div>