...
<div class="i_bg bg_color">
  ...
  <div class="m_content">
    ...
    <div class="m_right" id="content">
      ...
      <table border="0" class="order_tab" style="width:930px; text-align:center; margin-bottom:30px;" cellspacing="0" cellpadding="0">
        ...
        <c:forEach items="${list}" var="temp">
          <tr>
            ...
            <td>${temp.stock}</td>
            <td>${temp.price}</td>
            <td><a href="${ctx}/ProductListServlet?action=SelectIdProduct&id=${temp.id}">修改</a></td>
      ...
      <p align="right">
      		<a href="ProductServlet?id=1">首页</a>
           	<c:if test="${pageIndex!=1}"><a href="ProductServlet?pageIndex=${pageIndex-1}">上一页</a></c:if>
           	<c:if test="${pageIndex<pageCount}"><a href="ProductServlet?pageIndex=${pageIndex+1}">下一页</a></c:if>
           	<a href="ProductServlet?pageIndex=${pageCount}">末页</a>
